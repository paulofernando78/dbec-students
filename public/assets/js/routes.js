...
const routes = {
  ...
  // BEGINNER CLASS 3
  beginner_class_3_flipped_classroom_1b_world_music:
    "../pages/courses/1-beginner/class-3/flipped-classroom-1b-word-music.html",
  beginner_class_3_classwork_1b_world_music:
    "../pages/courses/1-beginner/class-3/classwork-1b-word-music.html",
  beginner_class_3_homework_1b_world_music:
    "../pages/courses/1-beginner/class-3/homework-1b-word-music.html",

  // BEGINNER CLASS 4
  beginner_class_4_flipped_classroom_video1_how_do_you_spell_it:
    "../pages/courses/1-beginner/class-4/flipped-classroom-video1-how-do-you-spell-it.html",
  beginner_class_4_classwork_video1_how_do_you_spell_it:
    "../pages/courses/1-beginner/class-4/classwork-video1-how-do-you-spell-it.html",
  beginner_class_4_homework_video1_how_do_you_spell_it:
    "../pages/courses/1-beginner/class-4/homework-video1-how-do-you-spell-it.html",

  // BEGINNER CLASS 5
  beginner_class_5_flipped_classroom_2a_are_you_on_vacation:
    "../pages/courses/1-beginner/class-5/flipped-classroom-2a-are-you-on-vacation.html",
  beginner_class_5_classwork_2a_are_you_on_vacation:
    "../pages/courses/1-beginner/class-5/classwork-2a-are-you-on-vacation.html",
  beginner_class_5_homework_2a_are_you_on_vacation:
    "../pages/courses/1-beginner/class-5/homework-2a-are-you-on-vacation.html",

  // BEGINNER CLASS 6
  beginner_class_6_flipped_classroom_2b_thats_my_bus:
    "../pages/courses/1-beginner/class-6/flipped-classroom-2b-thats-my-bus.html",
  beginner_class_6_classwork_2b_thats_my_bus:
    "../pages/courses/1-beginner/class-6/classwork-2b-thats-my-bus.html",
  beginner_class_6_homework_2b_thats_my_bus:
    "../pages/courses/1-beginner/class-6/homework-2b-thats-my-bus.html",

  // BEGINNER CLASS 7
  beginner_class_7_classwork_1_2_review_quiz:
    "../pages/courses/1-beginner/class-7/classwork-1-2-review-quiz.html",
  beginner_class_7_extra_homework_xxx: "",

  // BEGINNER CLASS 8
  beginner_class_8_flipped_classroom_3a_where_are_my_keys:
    "../pages/courses/1-beginner/class-8/flipped-classroom-3a-where-are-my-keys.html",
  beginner_class_8_classwork_3a_where_are_my_keys:
    "../pages/courses/1-beginner/class-8/classwork-3a-where-are-my-keys.html",
  beginner_class_8_homework_3a_where_are_my_keys:
    "../pages/courses/1-beginner/class-8/homework-3a-where-are-my-keys.html",

  // BEGINNER CLASS 9
  beginner_class_9_flipped_classroom_3b_souvenirs:
    "../pages/courses/1-beginner/class-9/flipped-classroom-3b-souvenirs.html",
  beginner_class_9_classwork_3b_souvenirs:
    "../pages/courses/1-beginner/class-9/classwork-3b-souvenirs.html",
  beginner_class_9_homework_3b_souvenirs:
    "../pages/courses/1-beginner/class-9/homework-3b-souvenirs.html",

  // BEGINNER CLASS 10
  beginner_class_10_flipped_classroom_video_2_can_I_have_an_orange_juice_please:
    "../pages/courses/1-beginner/class-10/flipped-classroom-video-2-can-I-have-an-orange-juice-please.html",
  beginner_class_10_classwork_video_2_can_I_have_an_orange_juice_please:
    "../pages/courses/1-beginner/class-10/classwork-video-2-can-I-have-an-orange-juice-please.html",
  beginner_class_10_homework_video_2_can_I_have_an_orange_juice_please:
    "../pages/courses/1-beginner/class-10/homework-video-2-can-I-have-an-orange-juice-please.html",

  // BEGINNER CLASS 11
  beginner_class_11_flipped_classroom_4a_meet_the_family:
    "../pages/courses/1-beginner/class-11/flipped-classroom-4a-meet-the-family.html",
  beginner_class_11_classwork_4a_meet_the_family:
    "../pages/courses/1-beginner/class-11/classwork-4a-meet-the-family.html",
  beginner_class_11_homework_4a_meet_the_family:
    "../pages/courses/1-beginner/class-11/homework-4a-meet-the-family.html",

  // BEGINNER CLASS 12
  beginner_class_12_flipped_classroom_4b_the_perfect_car:
    "../pages/courses/1-beginner/class-12/flipped-classroom-4b-the-perfect-car.html",
  beginner_class_12_classwork_4b_the_perfect_car:
    "../pages/courses/1-beginner/class-12/classwork-4b-the-perfect-car.html",
  beginner_class_12_homework_4b_the_perfect_car:
    "../pages/courses/1-beginner/class-12/homework-4b-the-perfect-car.html",

  // BEGINNER CLASS 13
  beginner_class_13_classwork_classwork_3_4_review_quiz:
    "../pages/courses/1-beginner/class-13/classwork-3-4-review-quiz.html",
  beginner_class_13_extra_homework_xxx: "",

  // BEGINNER CLASS 14
  beginner_class_14_flipped_classroom_5a_a_big_breakfast:
    "../pages/courses/1-beginner/class-14/flipped-classroom-5a-a-big-breakfast.html",
  beginner_class_14_classwork_5a_a_big_breakfast:
    "../pages/courses/1-beginner/class-14/classwork-5a-a-big-breakfast.html",
  beginner_class_14_homework_5a_a_big_breakfast:
    "../pages/courses/1-beginner/class-14/homework-5a-a-big-breakfast.html",

  // BEGINNER CLASS 15
  beginner_class_15_flipped_classroom_5b_a_very_long_flight:
    "../pages/courses/1-beginner/class-15/flipped-classroom-5b-a-very-long-flight.html",
  beginner_class_15_classwork_5b_a_very_long_flight:
    "../pages/courses/1-beginner/class-15/classwork-5b-a-very-long-flight.html",
  beginner_class_15_homework_5b_a_very_long_flight:
    "../pages/courses/1-beginner/class-15/homework-5b-a-very-long-flight.html",

  // BEGINNER CLASS 16
  beginner_class_16_flipped_classroom_video_3_what_time_is_it:
    "../pages/courses/1-beginner/class-16/flipped-classroom-video-3-what-time-is-it.html",
  beginner_class_16_classwork_video_3_what_time_is_it:
    "../pages/courses/1-beginner/class-16/classwork-video-3-what-time-is-it.html",
  beginner_class_16_homework_video_3_what_time_is_it:
  ...
  beginner_class_21_flipped_classroom_7b_lights_camera_action:
    "../pages/courses/1-beginner/class-21/flipped-classroom-7b-lights-camera-action.html",
  beginner_class_21_classwork_7b_lights_camera_action:
    "../pages/courses/1-beginner/class-21/classwork-7b-lights-camera-action.html",
  beginner_class_21_homework_7b_lights_camera_action:
    "../pages/courses/1-beginner/class-21/homework-7b-lights-camera-action.html",

  // BEGINNER CLASS 22
  beginner_class_22_flipped_classroom_video_4_whats_the_date:
    "../pages/courses/1-beginner/class-22/flipped-classroom-video-4-whats-the-date.html",
  beginner_class_22_classwork_video_4_whats_the_date:
    "../pages/courses/1-beginner/class-22/classwork-video-4-whats-the-date.html",
  beginner_class_22_homework_video_4_whats_the_date:
  ...
  intermediate_class_2_flipped_classroom_1a_eating_in_and_out:
    "../pages/courses/4-intermediate/class-2/flipped-classroom-1a-eating-in-and-out.html",
  intermediate_class_2_classwork_1a_eating_in_and_out:
    "../pages/courses/4-intermediate/class-2/classwork-1a-eating-in-and-out.html",
  intermediate_class_2_homework_1a_eating_in_and_out:
